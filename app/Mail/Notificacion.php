...
class Notificacion extends Mailable
{
    ...
    public function build()
    {
        ...
        $contenido=["Estimado/a ".$this->nombre.". Se otorgó un nuevo turno de sesión" ,
        ...
        $dp_profesion
               ...
               return $this->subject("Aviso de nuevo turno asignado")->view('emails.mensaje-enviado')->with(['contenido' => $contenido,]);
