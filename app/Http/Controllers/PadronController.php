...
class PadronController extends Controller
{
    ...
    public function traer(string $texto){
        $pacientes=Padron::whereRaw("estado<>2 and (apellido like'".$texto."%' or nombre like '".$texto."%')")->select('id','apellido','nombre','cobertura')->orderBy('apellido','asc')->orderBy('nombre','asc')->get();
        $t="";
